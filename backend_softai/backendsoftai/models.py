...
class Employe(models.Model):
    matricule = models.CharField(max_length=500)
    nom = models.CharField(max_length=250)
    prenom = models.CharField(max_length=200)
    departement = models.CharField(max_length=350)
    dob = models.CharField(max_length=9)
...
class Client(models.Model):
    nom = models.CharField(max_length=250)
    prenom = models.CharField(max_length=200)
    telephone = models.CharField(max_length=350)
